...
**Prediction App** is a web-based application for predicting 2025-26 UEFA Leagues match outcomes during league rounds. The app is designed for educational purposes and demonstrates integration of data scraping, cloud storage, and modern deployment techniques.
...
- Lets users predict match outcomes for UEFA ChampionsLeague/UEFA Europa/Conference League rounds
