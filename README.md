...
A learning project to practice Docker, CI/CD, and full-stack skills.

## Overview

**Prediction App** is a web-based application for predicting UEFA Europa League and UEFA Conference League match outcomes during league rounds. The app is designed for educational purposes and demonstrates integration of data scraping, cloud storage, and modern deployment techniques.
...
- Lets users predict match outcomes for UEFA Europa/Conference League rounds
...
- Full-stack app development with Python and React
...
Made by [Jasvendra Singh](https://github.com/JasvendraSingh)
